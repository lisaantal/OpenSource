...
#[derive(Debug)]
pub struct OpenSourceProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OpenSourceProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OpenSource processing");
    
    let mut processor = OpenSourceProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OpenSourceProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OpenSourceProcessor::new(false);
